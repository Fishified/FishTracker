...
class Calibration:
    ...
    def __init__(self,refcal_TE,refcalVideo_L,reftrialIndex_LE,refcameraID_LE,refdistance2pnts_LE,refrefDistance_LE):
    ...
    def openCalibration(self):
        self.fileobj=QFileDialog.getOpenFileName() #'Open Video File', '', None, QFileDialog.DontUseNativeDialog)
        self.myrefcalVideo_L.setText(self.fileobj)
        self.calibrationvideo=self.fileobj
